...
class TextFieldVC: UIViewController {
    ...
    func settingKeyboard() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.keyboardShow), name: UIResponder.keyboardDidShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(self.keyboardHide), name: UIResponder.keyboardDidHideNotification, object: nil)
    }
    ...
    @objc func keyboardShow(notification: NSNotification) {
        ...
        buttonBottomConstraints.constant = height
        let animationDuration = notiInfo[UIResponder.keyboardAnimationDurationUserInfoKey] as! TimeInterval
        
        // 애니메이션 효과를 키보드 애니메이션 시간과 동일하게
        UIView.animate(withDuration: animationDuration) {
            self.buttonBottomConstraints.constant = height
